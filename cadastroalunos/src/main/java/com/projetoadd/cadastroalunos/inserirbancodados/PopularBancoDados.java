...
public class PopularBancoDados implements CommandLineRunner {
    ...
    public void run(String... args) throws Exception {
        ...
        Aluno a1 = new Aluno("Joao", LocalDate.of(1990,04,12));
        Aluno a2 = new Aluno("Maria", LocalDate.of(1985,01,21));
        Aluno a3 = new Aluno("Pedro", LocalDate.of(1995,10,15));
        Aluno a4 = new Aluno("Jose", LocalDate.of(1987,02,27));
